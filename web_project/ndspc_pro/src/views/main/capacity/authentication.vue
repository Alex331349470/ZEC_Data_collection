  ...
  <div class="box">
    ...
    <div class="content-box">
      <el-table :data="tableData" style="width: 100%" ref="multipleTable" show-summary @selection-change="handleSelectionChange" :header-cell-style="{background:'#f0f2f5'}">
        ...
        <el-table-column prop="status" label="最后更新时间" sortable :show-overflow-tooltip="true" width="120" align="center" />
...
import Search from './components/authentication/search.vue'
...
onMounted(() => {
  const {refetch} = useQuery(testQuery)
})
// 数据录入
function handleAdd() {
  addForm.value = {}
